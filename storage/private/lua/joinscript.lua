...
local success, err = pcall(function()  
  ...
  playerConnectSucces, player = pcall(function() return client:PlayerConnect(%userid%, "%ip%", 53640, 0, threadSleepTime) end)
  ...
  player.CharacterAppearance = "http://www.robloc.icu/CharacterFetch.ashx?userId=%userid%"
